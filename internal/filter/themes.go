...
var StyleGroups = []StyleGroup{
	...
	{ID: GroupWhitelist, Sample: "Sibilant Catalyst", AllowDefault: true,
		FontSize: 38,
		Default:  Theme{BgColor: "30 30 34 230", TextColor: "235 235 235 255", Border: "150 150 160 255"}},
