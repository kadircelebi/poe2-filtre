...
var en = map[string]string{
	...
	"overlay.err.tooBroad":            "The search is too broad for GGG; add a base type, a rarity or a few affix filters",
	"overlay.err.weightNeedsLogin":    "GGG accepts Weighted Sum groups only in searches signed in to pathofexile.com. Link your browser under Settings → Account, or make the group And or Count (e.g. Count, at least 3)",
	"overlay.err.sessionIgnored":      "GGG treated this search as signed out: the linked session was not recognised (it may have expired or been logged out). Settings → Account → Reconnect",
	...
	"overlay.err.hideoutNeedsLogin":   "To travel to a hideout, link your browser under Settings → Account",
	"live.err.login":                  "Live search needs a signed-in pathofexile.com account: link your browser under Settings → Account",
	"live.err.limit":                  "At most %d live searches can run at once",
	"live.err.auth":                   "GGG refused the session; link your browser again under Settings → Account",
	...
	"live.notifyOne":                  "%s — %s",
	"live.notifyMany":                 "%d new listings · %s — %s",
	"overlay.err.hideoutDenied":       "GGG refused: the item may have sold, or the game is not running on this account",
	"overlay.err.hideoutSession":      "GGG did not accept the session; reconnect in Settings",
	"overlay.err.hideoutLimit":        "GGG's request limit was reached; try again in a few seconds",
	"overlay.quota.shared":            "This IP's %s search window is nearly full (%d/%d, the trade site and other apps included). Try again in %s",
	"overlay.quota.ours":              "The app's own limit: %s window reached %d searches (GGG's limit is %d). Try again in %s",
	"overlay.quota.wait":              "GGG's search quota is waiting; try again in %s",
	"overlay.quota.penaltyWindow":     "GGG put a search penalty on this IP: the %s window's limit of %d searches was exceeded. It ends in %s",
	"overlay.quota.penalty":           "GGG put a search penalty on this IP (it did not say which window). It ends in %s",
	"overlay.window.hours":            "%d-hour",
	"overlay.window.minutes":          "%d-minute",
	"overlay.window.seconds":          "%d-second",
	"overlay.wait.soon":               "a moment",
	"overlay.wait.sec":                "%d s",
	"overlay.wait.min":                "%d min",
	"overlay.wait.minSec":             "%d min %d s",
	"overlay.wait.hourMin":            "%d h %d min",
	"overlay.hover":                   "Hover an item in Path of Exile 2 and press the shortcut.",
	"overlay.noCopy":                  "No item was copied. Hover an item in Path of Exile 2 and try again.",
	"overlay.notAnItem":               "What was copied is not a Path of Exile 2 item.",
	"overlay.catalogFailed":           "The trade catalogue could not be loaded: %v",
	"account.err.port":                "could not open the local port for the browser link (%s); another program may be using it",
	"scan.last.error":                 " — error",
	"scan.last.classLearned":          " — class learned",
	"scan.last.noListings":            " — no listings",
	"scan.last.listings":              " — %d listings",
}
