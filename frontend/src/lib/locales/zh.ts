export const zh: Record<string, string> = {
  ...
  'tier.t5rareHint': '此 tier 以上會顯示',
  'tier.jewels': 'Rare jewel',
  'tier.jewelsHint': '低於所選 tier 的會被隱藏',
  'tier.uncut': 'Uncut skill 與 spirit gem',
  'tier.uncutHint': '此等級以上顯示，其餘隱藏',
  'tier.support': 'Uncut support gem',
  'tier.supportHint': '掉落非常頻繁，因此有自己的等級',
  'tier.waystones': 'Waystone',
  'tier.waystonesHint': '此 tier 以上會強調顯示',
