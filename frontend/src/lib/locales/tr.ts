export const tr: Record<string, string> = {
  ...
  'tier.t5rareHint': 'Bu tier ve üstü gösterilir',
  'tier.jewels': "Rare jewel'lar",
  'tier.jewelsHint': 'Seçilen tier\'ın altındakiler gizlenir',
  'tier.uncut': "Uncut skill ve spirit gem'ler",
  'tier.uncutHint': 'Bu seviye ve üstü gösterilir, kalanı gizlenir',
  'tier.support': "Uncut support gem'ler",
  'tier.supportHint': 'Sürekli düştükleri için kendi seviyeleri var',
  'tier.waystones': "Waystone'lar",
  'tier.waystonesHint': 'Bu tier ve üstü vurgulanır',
